...
const { authenticate, optionalAuth, requireAdmin, requireMerchant } = require('../middleware/auth_middleware');
...
// 获取酒店详情不需要认证（用户端查看详情）
router.get('/:id', optionalAuth, hotelController.getHotelById);
